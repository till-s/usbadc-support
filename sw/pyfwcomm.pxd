...
# cpdef note:
#
# For seamless interoperation to work:
#
#  1. cpdef must be inside the 'cdef extern from <header>'
#     section.
#  2. in C header the enum must named, i.e.,
...
cdef extern from "versaClkSup.h":
  cpdef enum VersaClkFODRoute "VersaClkFODRoute":
    NORMAL   = 0
    CASC_FOD = 1
    CASC_OUT = 2
    OFF      = 3
